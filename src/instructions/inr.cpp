...
//                       INR Impl
// =============================================================================
INR::INR(const std::string& instruction) : ICommand(instruction) {
    parse(Parser::SingleOperand);
}

bool INR::execute(Model& model) {
...
void INR::undo(Model& model) {
}

void INR::setup_opcode_table() {
    uint8_t current_opcode = 0x04;
